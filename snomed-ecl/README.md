...
`descriptionLength`/`domainConstraint`/`parentDomain` (e.g.
`proximalPrimitiveConstraint`, `grouped`) are rejected too, but currently with a generic parse
