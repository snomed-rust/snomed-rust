...
`proximalPrimitiveConstraint`/`proximalPrimitiveRefinement` (e.g.
`domainTemplateForPrecoordination`, `grouped`) are rejected too, but currently with a generic parse
