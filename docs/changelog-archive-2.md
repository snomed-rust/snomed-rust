...
Entries for versions 0.10.0 and earlier, moved verbatim from
[`changelog-archive.md`](changelog-archive.md) — itself moved verbatim
from [`CHANGELOG.md`](../CHANGELOG.md) — to keep that file inside the
