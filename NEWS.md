...
| | |
|---|---|
| Version | **0.28.0**, released 2026-09-06 |
...
0.28.0 gives the ECL `{{ M ... }}` member filter constraint's
`memberFieldFilter` alternative its thirteenth column,
`attributeDescription` — the seventh implemented outside the two map
types (`RefsetDescriptorRefsetMember`). Purely additive: no public API
...
- **Maturity.** Version 0.28.0, first published in September 2026, one
